...
| 11 — Workspaces | Central `~/.drummer` storage, Scratch catchall, external folders, bare `drummer` launches, top-bar workspace switcher | 🚧 In progress |
| 12 — Theming | Dark / light / system-auto toggle across the app and tutorial | ⬜ Planned |
